...
**6) References**
- Output: Only works cited in the review AND in the manuscript's reference list. Format: `[Author et al., Year]`. If none: "None."
...
**6) References**
输出：仅列出审稿中引用且出现在稿件参考文献中的条目。格式：[作者等，年份]。无则写「无」。
