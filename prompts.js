...
- Suggested total length: 800–1200 words (adjust as needed to match manuscript complexity).`,
  ...
  // 英文 Few-shot 提示词
  "prompt-en-fewshot": `Please refer to the contents of Review A (ResNet) and Review B (Verified), and combine with the following requirements to generate review comments for the article.
...
- 紧贴证据锚点，优先多重证据。
 ...
 - 为保证信息密度与可读性：
  ...
  // 中文 Few-shot 提示词
  "prompt-zh-fewshot": `请参考Review A (ResNet)和Review B (Verified)的审稿内容，并结合以下要求，为文章生成评审意见。
