...
- **[20/08/2026]** 新增 **Relative Rank**：把你的稿件与目标会议论文（或你自己上传的对照稿）比较，快速定位相对竞争力。入口见[这里](https://ai-review.neurodong.top/compete.html)。100 组评估见 [Examples/Relative_Rank_evaluation.md](Examples/Relative_Rank_evaluation.md)。
